...
var app = (function () {
    ...
    const file = "Users/spencer/mountain/somehow-timeline/src/Timeline.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 61, 0, 1228);
    		},
    ...
    class Timeline extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-kav09m-style")) add_css();
    		init(this, options, instance, create_fragment, safe_not_equal, { start: 4, end: 5, height: 6 });
    ...
    /* Users/spencer/mountain/somehow-timeline/src/shapes/Ticks.svelte generated by Svelte v3.24.1 */
    const file$1 = "Users/spencer/mountain/somehow-timeline/src/shapes/Ticks.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "label svelte-1e7wl3m");
    			...
    			add_location(div, file$1, 72, 4, 1566);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-1e7wl3m");
    			set_style(div, "opacity", /*opacity*/ ctx[3]);
    			add_location(div, file$1, 70, 0, 1487);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Ticks extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1e7wl3m-style")) add_css$1();
    ...
    const file$2 = "Users/spencer/mountain/somehow-timeline/src/shapes/Axis.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 87, 4, 1888);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 85, 0, 1836);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Axis extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-16g1s6d-style")) add_css$2();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { format: 5, every: 6, size: 1, color: 0 });
    ...
    const file$3 = "Users/spencer/mountain/somehow-timeline/src/shapes/Column.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$3, 25, 0, 437);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Column extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1u6y9h5-style")) add_css$3();
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { label: 0, color: 1, title: 3, margin: 2 });
    ...
    /* Users/spencer/mountain/somehow-timeline/src/shapes/Now.svelte generated by Svelte v3.24.1 */
    const file$4 = "Users/spencer/mountain/somehow-timeline/src/shapes/Now.svelte";

    function add_css$4() {
    	var style = element("style");
    	style.id = "svelte-fvmo05-style";
    	style.textContent = ".line.svelte-fvmo05{position:relative;margin:0px}.container.svelte-fvmo05{z-index:-1;width:100%;height:100%;position:absolute}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			attr_dev(div0, "class", "line svelte-fvmo05");
    			set_style(div0, "border-bottom", /*width*/ ctx[1] + " dashed " + /*color*/ ctx[0]);
    			set_style(div0, "top", /*y*/ ctx[2] + "px");
    			add_location(div0, file$4, 35, 2, 743);
    			attr_dev(div1, "class", "container svelte-fvmo05");
    			add_location(div1, file$4, 32, 0, 618);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Now extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-fvmo05-style")) add_css$4();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { color: 0, width: 1, label: 3, now: 4 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$5, 19, 6, 413);
    			...
    			add_location(pattern, file$5, 18, 4, 329);
    			add_location(defs, file$5, 17, 2, 318);
    			attr_dev(rect, "x", "0");
    			attr_dev(rect, "y", "0");
    			attr_dev(rect, "width", "100%");
    			attr_dev(rect, "height", "100%");
    			attr_dev(rect, "fill", rect_fill_value = "url(#" + /*id*/ ctx[1] + ")");
    			add_location(rect, file$5, 23, 2, 487);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$5, 16, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    const file$6 = "Users/spencer/mountain/somehow-timeline/src/shapes/Label.svelte";

    function add_css$5() {
    	var style = element("style");
    	style.id = "svelte-309jbi-style";
    	style.textContent = ".container.svelte-309jbi{width:100%;position:absolute;border-radius:5px;display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:left;flex-wrap:nowrap;align-self:stretch}.line.svelte-309jbi{height:100%;width:25px;cursor:default;border-radius:3px;z-index:1;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.line.svelte-309jbi:hover{opacity:1;box-shadow:2px 2px 8px 0px steelblue}.label.svelte-309jbi{flex:1;margin-left:10%}.isTiny.svelte-309jbi{font-size:0.7rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$6, 82, 2, 1849);
    			...
    			add_location(div1, file$6, 83, 2, 1925);
    			...
    			add_location(div2, file$6, 79, 0, 1716);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Label extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-309jbi-style")) add_css$5();
    ...
    /* Users/spencer/mountain/somehow-timeline/src/shapes/Pill.svelte generated by Svelte v3.24.1 */
    const file$7 = "Users/spencer/mountain/somehow-timeline/src/shapes/Pill.svelte";

    function add_css$6() {
    	var style = element("style");
    	style.id = "svelte-1g2gu3x-style";
    	style.textContent = ".container.svelte-1g2gu3x{width:100%;position:absolute;border-radius:5px;display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:left;flex-wrap:nowrap;align-self:stretch}.line.svelte-1g2gu3x{height:100%;width:25px;cursor:default;border-radius:3px;z-index:1;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.line.svelte-1g2gu3x:hover{opacity:1;box-shadow:2px 2px 8px 0px steelblue}.label.svelte-1g2gu3x{position:absolute;width:150px;left:30px;min-height:50px;flex:1;z-index:6;font-size:1.6rem}.sub.svelte-1g2gu3x{color:grey;font-size:1rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t2 = text(/*sub*/ ctx[7]);
    			attr_dev(div0, "class", "sub svelte-1g2gu3x");
    			add_location(div0, file$7, 101, 6, 2376);
    			attr_dev(div1, "class", "label svelte-1g2gu3x");
    			set_style(div1, "color", /*color*/ ctx[0]);
    			set_style(div1, "font-size", /*size*/ ctx[5]);
    			add_render_callback(() => /*div1_elementresize_handler*/ ctx[20].call(div1));
    			add_location(div1, file$7, 99, 4, 2274);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, t0);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*sub*/ 128) set_data_dev(t2, /*sub*/ ctx[7]);
    ...
    function create_fragment$7(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*show*/ ctx[10] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "line svelte-1g2gu3x");
    			set_style(div0, "max-width", /*width*/ ctx[1]);
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location(div0, file$7, 92, 2, 2066);
    			attr_dev(div1, "class", "container svelte-1g2gu3x");
    			set_style(div1, "opacity", /*opacity*/ ctx[4]);
    			set_style(div1, "top", /*top*/ ctx[11] + /*margin*/ ctx[3] + "px");
    			set_style(div1, "height", /*height*/ ctx[12] - /*margin*/ ctx[3] * 2 + "px");
    			attr_dev(div1, "title", /*title*/ ctx[2]);
    			add_location(div1, file$7, 89, 0, 1933);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(div0, "mouseover", /*mouseover_handler*/ ctx[17], false, false, false),
    					listen_dev(div0, "mouseout", /*mouseout_handler*/ ctx[18], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*top, margin*/ 2056) {
    				set_style(div1, "top", /*top*/ ctx[11] + /*margin*/ ctx[3] + "px");
    			}

    			if (dirty & /*height, margin*/ 4104) {
    				set_style(div1, "height", /*height*/ ctx[12] - /*margin*/ ctx[3] * 2 + "px");
    			}
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const mouseover_handler = () => $$invalidate(10, show = true);
    	const mouseout_handler = () => $$invalidate(10, show = false);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("size" in $$props) $$invalidate(5, size = $$props.size);
    		if ("label" in $$props) $$invalidate(6, label = $$props.label);
    		if ("sub" in $$props) $$invalidate(7, sub = $$props.sub);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("myScale" in $$props) $$invalidate(23, myScale = $$props.myScale);
    		if ("color" in $$props) $$invalidate(0, color = $$props.color);
    		if ("width" in $$props) $$invalidate(1, width = $$props.width);
    		if ("title" in $$props) $$invalidate(2, title = $$props.title);
    		if ("margin" in $$props) $$invalidate(3, margin = $$props.margin);
    		...
    		if ("date" in $$props) $$invalidate(16, date = $$props.date);
    		if ("end" in $$props) $$invalidate(14, end = $$props.end);
    		if ("isTiny" in $$props) isTiny = $$props.isTiny;
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*start*/ 8192) {
    			 $$invalidate(11, top = myScale(start));
    		}

    		if ($$self.$$.dirty & /*end*/ 16384) {
    			 $$invalidate(22, bottom = myScale(end));
    		}

    		if ($$self.$$.dirty & /*bottom, top*/ 4196352) {
    			 $$invalidate(12, height = bottom - top);
    		}
    	};
    ...
    class Pill extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1g2gu3x-style")) add_css$6();
    ...
    function add_css$7() {
    	var style = element("style");
    	style.id = "svelte-1eg2kx8-style";
    	style.textContent = ".container.svelte-1eg2kx8{position:relative;min-height:100vh;max-height:100vh;height:100%}.col.svelte-1eg2kx8{display:flex;flex-direction:column;justify-content:space-between;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}body{background-color:#c7c8ca;min-height:100%;margin:0px}#imgbox.svelte-1eg2kx8{position:relative;width:100%;max-width:100%;overflow:hidden;height:370px;min-height:370px;border-top:4px solid #657da1}#slider.svelte-1eg2kx8{position:absolute;top:-300px;position:absolute;z-index:1;transition:left 0.8s}.dir.svelte-1eg2kx8{position:absolute;font-size:25px;top:10px;z-index:5;color:#50617a}#label.svelte-1eg2kx8{position:absolute;left:30%;width:40%;text-align:center;font-size:25px;top:10px;z-index:5;color:#657da1}.title.svelte-1eg2kx8{font-size:1rem;color:#657da1;text-align:left;align-self:flex-start;margin-left:15px;font-size:0.9rem}#timelinescroll.svelte-1eg2kx8{flex:1;width:100%;overflow-y:scroll;overflow-x:hidden}#timeline.svelte-1eg2kx8{margin-top:2rem;margin-left:10%;margin-right:10%}#arrow.svelte-1eg2kx8{position:absolute;left:50%;height:45px;width:2px;background-color:#657da1;top:60px;z-index:5}.sub.svelte-1eg2kx8{position:relative;color:grey;font-size:1rem;margin-top:2px;left:38px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	function func(...args) {
    		return /*func*/ ctx[6](/*obj*/ ctx[11], ...args);
    	}

    	pill = new Pill({
    			props: {
    				width: "20px",
    				start: /*obj*/ ctx[11].start,
    				end: /*obj*/ ctx[11].end,
    				color: /*obj*/ ctx[11].construction ? "#86b3a7" : "blue",
    				label: /*obj*/ ctx[11].name,
    				onClick: func,
    				opacity: "0.8",
    				size: "1rem"
    			},
    ...
    // (158:6) <Timeline start="jan 1 2008" end="Dec 30 2040" height="500">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(158:6) <Timeline start=\\\"jan 1 2008\\\" end=\\\"Dec 30 2040\\\" height=\\\"500\\\">",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div11 = element("div");
    			div1 = element("div");
    			t0 = text("proof of concept for\n    ");
    			a = element("a");
    			a.textContent = "stephen velasco";
    			t2 = space();
    			div0 = element("div");
    			div0.textContent = "mock construction timeline";
    			t4 = space();
    			div3 = element("div");
    			div2 = element("div");
    			...
    			add_location(a, file$8, 151, 4, 2565);
    			add_location(div0, file$8, 152, 4, 2631);
    			attr_dev(div1, "class", "title svelte-1eg2kx8");
    			add_location(div1, file$8, 148, 2, 2465);
    			attr_dev(div2, "id", "timeline");
    			attr_dev(div2, "class", "svelte-1eg2kx8");
    			add_location(div2, file$8, 156, 4, 2737);
    			attr_dev(div3, "id", "timelinescroll");
    			set_style(div3, "max-width", "1000px");
    			attr_dev(div3, "class", "svelte-1eg2kx8");
    			add_location(div3, file$8, 155, 2, 2681);
    			attr_dev(div4, "class", "sub svelte-1eg2kx8");
    			add_location(div4, file$8, 184, 6, 3466);
    			attr_dev(div5, "id", "label");
    			attr_dev(div5, "class", "svelte-1eg2kx8");
    			add_location(div5, file$8, 182, 4, 3430);
    			attr_dev(div6, "id", "arrow");
    			attr_dev(div6, "class", "svelte-1eg2kx8");
    			add_location(div6, file$8, 186, 4, 3510);
    			attr_dev(div7, "class", "dir svelte-1eg2kx8");
    			set_style(div7, "left", "20px");
    			add_location(div7, file$8, 187, 4, 3533);
    			attr_dev(div8, "class", "dir svelte-1eg2kx8");
    			set_style(div8, "right", "20px");
    			add_location(div8, file$8, 188, 4, 3582);
    			set_style(img, "min-width", "5000px");
    			if (img.src !== (img_src_value = "./assets/from-west.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$8, 191, 6, 3681);
    			attr_dev(div9, "id", "slider");
    			set_style(div9, "left", /*left*/ ctx[1] + "px");
    			attr_dev(div9, "class", "svelte-1eg2kx8");
    			add_location(div9, file$8, 189, 4, 3632);
    			attr_dev(div10, "id", "imgbox");
    			set_style(div10, "overflow", "hidden");
    			attr_dev(div10, "class", "svelte-1eg2kx8");
    			add_location(div10, file$8, 181, 2, 3383);
    			attr_dev(div11, "class", "container col svelte-1eg2kx8");
    			add_location(div11, file$8, 146, 0, 2434);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*name*/ 4) set_data_dev(t6, /*name*/ ctx[2]);
    			if (!current || dirty & /*sub*/ 8) set_data_dev(t8, /*sub*/ ctx[3]);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	return [screen, left, name, sub, goTo, onwindowresize, func];
    }

    class Demo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1eg2kx8-style")) add_css$7();
