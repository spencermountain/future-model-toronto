...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 71, 4, 1565);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 69, 0, 1486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function add_css$2() {
    	...
    	style.textContent = ".container.svelte-16g1s6d{position:relative;min-width:50px}.label.svelte-16g1s6d{position:absolute;white-space:nowrap;left:6px;text-align:left;transform:translate(0px, -8px);opacity:0.5;height:1.3rem;font-size:8px}.underline.svelte-16g1s6d{font-size:10px;border-bottom:1px solid grey;opacity:1}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 87, 4, 1887);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 85, 0, 1835);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "Users/spencer/mountain/somehow-timeline/src/shapes/Dots.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$4, 19, 6, 413);
    			...
    			add_location(pattern, file$4, 18, 4, 329);
    			add_location(defs, file$4, 17, 2, 318);
    			attr_dev(rect, "x", "0");
    			attr_dev(rect, "y", "0");
    			attr_dev(rect, "width", "100%");
    			attr_dev(rect, "height", "100%");
    			attr_dev(rect, "fill", rect_fill_value = "url(#" + /*id*/ ctx[1] + ")");
    			add_location(rect, file$4, 23, 2, 487);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$4, 16, 0, 283);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    const file$5 = "Users/spencer/mountain/somehow-timeline/src/shapes/Label.svelte";

    function add_css$4() {
    	var style = element("style");
    	style.id = "svelte-309jbi-style";
    	style.textContent = ".container.svelte-309jbi{width:100%;position:absolute;border-radius:5px;display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:left;flex-wrap:nowrap;align-self:stretch}.line.svelte-309jbi{height:100%;width:25px;cursor:default;border-radius:3px;z-index:1;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2)}.line.svelte-309jbi:hover{opacity:1;box-shadow:2px 2px 8px 0px steelblue}.label.svelte-309jbi{flex:1;margin-left:10%}.isTiny.svelte-309jbi{font-size:0.7rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 81, 2, 1817);
    			...
    			toggle_class(div1, "isTiny", /*isTiny*/ ctx[8]);
    			add_location(div1, file$5, 82, 2, 1893);
    			...
    			add_location(div2, file$5, 78, 0, 1684);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*top, margin*/ 520) {
    				set_style(div2, "top", /*top*/ ctx[9] + /*margin*/ ctx[3] + "px");
    			}

    			if (dirty & /*height, margin*/ 1032) {
    				set_style(div2, "height", /*height*/ ctx[10] - /*margin*/ ctx[3] * 2 + "px");
    			}
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("date" in $$props) $$invalidate(14, date = $$props.date);
    		if ("end" in $$props) $$invalidate(12, end = $$props.end);
    		if ("isTiny" in $$props) $$invalidate(8, isTiny = $$props.isTiny);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*bottom, top*/ 66048) {
    ...
    class Label extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-309jbi-style")) add_css$4();
    ...
    function add_css$5() {
    	var style = element("style");
    	style.id = "svelte-7creig-style";
    	style.textContent = ".container.svelte-7creig{position:relative;min-height:100vh;max-height:100vh;height:100%}.col.svelte-7creig{display:flex;flex-direction:column;justify-content:space-between;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}body{background-color:#c7c8ca;min-height:100%;margin:0px}#imgbox.svelte-7creig{position:relative;width:100%;max-width:100%;overflow:hidden;height:420px;min-height:420px;border-top:4px solid #657da1}#slider.svelte-7creig{position:absolute;top:-250px;position:absolute;left:-2500px;z-index:1}.dir.svelte-7creig{position:absolute;font-size:25px;top:10px;z-index:5;color:#50617a}#label.svelte-7creig{position:absolute;left:30%;width:40%;text-align:center;font-size:25px;top:10px;z-index:5;color:#657da1}.title.svelte-7creig{font-size:1rem;color:#657da1;text-align:left;align-self:flex-start;margin-left:15px;font-size:0.9rem}#timelinescroll.svelte-7creig{flex:1;width:100%;overflow-y:scroll;overflow-x:hidden}#timeline.svelte-7creig{margin-left:10%;margin-right:10%}#arrow.svelte-7creig{position:absolute;left:50%;height:40px;width:2px;background-color:#657da1;top:60px;z-index:5}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	label = new Label({
    			props: {
    				width: "20px",
    				start: /*obj*/ ctx[3].start,
    				end: /*obj*/ ctx[3].end,
    				color: /*obj*/ ctx[3].construction ? "blue" : "#86b3a7",
    				label: "",
    				opacity: "0.8",
    				size: "12px"
    			},
    ...
    function create_each_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(117:8) {#each columns as col}",
    		ctx
    	});
    ...
    // (113:6) <Timeline start="jan 1 2008" end="Dec 30 2040" height="400">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(113:6) <Timeline start=\\\"jan 1 2008\\\" end=\\\"Dec 30 2040\\\" height=\\\"400\\\">",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			b = element("b");
    			b.textContent = "Toronto contstruction timeline";
    			...
    			div8 = element("div");
    			div3 = element("div");
    			div3.textContent = "Toronto City Hall";
    			t6 = space();
    			div4 = element("div");
    			t7 = space();
    			div5 = element("div");
    			...
    			div7 = element("div");
    			img = element("img");
    			add_location(b, file$6, 105, 4, 1850);
    			attr_dev(a, "href", "https://www.stephenvelasco.com/");
    			add_location(a, file$6, 107, 4, 1919);
    			attr_dev(div0, "class", "title svelte-7creig");
    			add_location(div0, file$6, 104, 2, 1826);
    			attr_dev(div1, "id", "timeline");
    			attr_dev(div1, "class", "svelte-7creig");
    			add_location(div1, file$6, 111, 4, 2023);
    			attr_dev(div2, "id", "timelinescroll");
    			attr_dev(div2, "class", "svelte-7creig");
    			add_location(div2, file$6, 110, 2, 1993);
    			attr_dev(div3, "id", "label");
    			attr_dev(div3, "class", "svelte-7creig");
    			add_location(div3, file$6, 136, 4, 2629);
    			attr_dev(div4, "id", "arrow");
    			attr_dev(div4, "class", "svelte-7creig");
    			add_location(div4, file$6, 137, 4, 2673);
    			attr_dev(div5, "class", "dir svelte-7creig");
    			set_style(div5, "left", "20px");
    			add_location(div5, file$6, 138, 4, 2696);
    			attr_dev(div6, "class", "dir svelte-7creig");
    			set_style(div6, "right", "20px");
    			add_location(div6, file$6, 139, 4, 2745);
    			set_style(img, "min-width", "5000px");
    			if (img.src !== (img_src_value = "./assets/from-west.jpeg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 141, 6, 2819);
    			attr_dev(div7, "id", "slider");
    			attr_dev(div7, "class", "svelte-7creig");
    			add_location(div7, file$6, 140, 4, 2795);
    			attr_dev(div8, "id", "imgbox");
    			attr_dev(div8, "class", "svelte-7creig");
    			add_location(div8, file$6, 135, 2, 2607);
    			attr_dev(div9, "class", "container col svelte-7creig");
    			add_location(div9, file$6, 102, 0, 1795);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Demo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-7creig-style")) add_css$5();
